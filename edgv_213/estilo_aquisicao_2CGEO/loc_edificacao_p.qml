...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="situacaofisica" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="1" value="4" label="Planejada"/>
      <category render="true" symbol="2" value="3" label="Em Construção"/>
      <category render="true" symbol="3" value="2" label="Destruída"/>
      <category render="true" symbol="4" value="1" label="Abandonada"/>
      <category render="true" symbol="5" value="0" label="Desconhecida"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/shadowColorB" value="44"/>
    <property key="labeling/shadowColorG" value="160"/>
    <property key="labeling/shadowColorR" value="51"/>
