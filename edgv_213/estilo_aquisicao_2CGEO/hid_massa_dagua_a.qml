...
<qgis version="2.16.0-Nødebo" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{4ce34ef1-7bc1-4f24-8019-23f9bcd282d9}">
      <rule filter="&quot;tipomassadagua&quot;=0" key="{5fb092b2-2f6f-49b3-9183-2e65cdaf5630}" symbol="0" label="Desconhecido"/>
      <rule filter="&quot;tipomassadagua&quot;=7" key="{6888d81e-2c43-402a-b2d1-d092e8ebe86a}" symbol="1" label="Lago Lagoa"/>
      <rule filter="&quot;tipotrechomassa&quot;=10" key="{17a8a6ce-ff92-4f38-81a9-a08914980f5a}" symbol="2" label="Represa/açude"/>
      <rule filter="&quot;salinidade&quot; = 2" key="{b3200377-f33a-4f3b-80eb-3930fc242636}" symbol="3" label="Salgado"/>
      <rule filter="&quot;tipotrechomassa&quot;=2" key="{41a8d130-8c63-422e-8127-16988057f4c9}" symbol="4" label="Canal"/>
      <rule filter="&quot;tipotrechomassa&quot;=9" key="{0b4d7588-35a7-4bed-b522-c11ac10d61cb}" symbol="5" label="Laguna"/>
      <rule filter="&quot;regime&quot;=1" key="{cb641415-b1c2-440d-947d-20f837ea48fc}" symbol="6" label="Permanente"/>
      <rule filter="&quot;regime&quot;=3" key="{cf693e8a-fe2c-4a47-a972-89e8287b1713}" symbol="7" label="Temporário"/>
      <rule filter="&quot;regime&quot;=2" key="{e04bf627-1ada-48a7-90c9-7c314cef7e01}" symbol="8" label="Permanente com grande variação"/>
      <rule filter="&quot;regime&quot;=4" key="{f32a37ee-31ec-4419-bb69-fb08874f6436}" symbol="9" label="Temporário com leito permanente"/>
      <rule filter="ELSE" key="{dba476cd-9a7a-48d7-af8b-a5fddddcdd37}" symbol="10"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="5">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-149547571">
    <columns>
