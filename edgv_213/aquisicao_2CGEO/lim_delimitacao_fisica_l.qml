...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipodelimfis">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Cerca" value="1"/>
        <value key="Desconhecido" value="0"/>
        <value key="Muro" value="2"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="matconstr">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Alvenaria" value="1"/>
        <value key="Arame" value="6"/>
        <value key="Cerca viva" value="8"/>
        <value key="Desconhecido" value="0"/>
        <value key="Madeira" value="5"/>
        <value key="Outros" value="99"/>
        <value key="Rocha" value="4"/>
        <value key="Tela ou Alambrado" value="7"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipodelimfis" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="Desconhecido"/>
      <category render="true" symbol="1" value="1" label="Cerca"/>
      <category render="true" symbol="2" value="2" label="Muro"/>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="143,201,114,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="157,27,222,255"/>
          <prop k="line_style" v="dot"/>
          <prop k="line_width" v="0.8"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="157,92,154,255"/>
          <prop k="line_style" v="dot"/>
          <prop k="line_width" v="0.8"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="249,177,99,255"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="180,41,218,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE &#xd;&#xa;WHEN &quot;tipodelimfis&quot; = 0 then  'Desconhcido' &#xd;&#xa;WHEN &quot;tipodelimfis&quot; = 1 then  'Cerca'&#xd;&#xa;WHEN &quot;tipodelimfis&quot; = 2 then  'Muro'&#xd;&#xa;ELSE&#xd;&#xa;''&#xd;&#xa;END"/>
  ...
  <aliases>
    ...
    <alias field="tipodelimfis" index="4" name=""/>
    <alias field="matconstr" index="5" name=""/>
    <alias field="eletrificada" index="6" name=""/>
    <alias field="lenght_otf" index="7" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="tipodelimfis"/>
      <column width="-1" hidden="0" type="field" name="matconstr"/>
      <column width="-1" hidden="0" type="field" name="eletrificada"/>
