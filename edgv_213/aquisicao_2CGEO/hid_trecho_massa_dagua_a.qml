...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{4ce34ef1-7bc1-4f24-8019-23f9bcd282d9}">
      ...
      <rule filter="&quot;regime&quot;=1" key="{cb641415-b1c2-440d-947d-20f837ea48fc}" symbol="7" label="Permanente"/>
      <rule filter="&quot;regime&quot;=3" key="{cf693e8a-fe2c-4a47-a972-89e8287b1713}" symbol="8" label="Temporário"/>
      <rule filter="&quot;regime&quot;=2" key="{e04bf627-1ada-48a7-90c9-7c314cef7e01}" symbol="9" label="Permanente com grande variação"/>
      <rule filter="&quot;regime&quot;=4" key="{f32a37ee-31ec-4419-bb69-fb08874f6436}" symbol="10" label="Temporário com leito permanente"/>
      <rule filter="ELSE" key="{dba476cd-9a7a-48d7-af8b-a5fddddcdd37}" symbol="11"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.976471" clip_to_extent="1" type="fill" name="6">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
  ...
  <aliases>
    ...
    <alias field="tipotrechomassa" index="3" name=""/>
    <alias field="regime" index="4" name=""/>
    <alias field="salinidade" index="5" name=""/>
    <alias field="id_trecho_curso_dagua" index="6" name=""/>
    <alias field="observacao" index="7" name=""/>
    <alias field="data_modificacao" index="8" name=""/>
    <alias field="controle_id" index="9" name=""/>
    <alias field="ultimo_usuario" index="10" name=""/>
    <alias field="area_otf" index="11" name=""/>
  </aliases>
