...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="node_type">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="ConfluÃªncia" value="5"/>
        <value key="Flag" value="0"/>
        <value key="InterrupÃ§Ã£o Ã  Jusante" value="4"/>
        <value key="InterrupÃ§Ã£o Ã  Montante" value="3"/>
        <value key="InÃ­cio de Trecho" value="2"/>
        <value key="MudanÃ§a de Atributo" value="7"/>
        <value key="NÃ³ PrÃ³ximo a Corpo d'Ãgua" value="8"/>
        <value key="RamificaÃ§Ã£o" value="6"/>
        <value key="Sumidouro ou Vertedouro" value="1"/>
      </widgetv2config>
    </edittype>
  </edittypes>
  <renderer-v2 attr="node_type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="Flag"/>
      <category render="true" symbol="1" value="1" label="Sumidouro ou Vertedouro"/>
      <category render="true" symbol="2" value="2" label="Início de Trecho"/>
      <category render="true" symbol="3" value="3" label="Interrupção à Montante"/>
      <category render="true" symbol="4" value="4" label="Interrupção à Jusante"/>
      <category render="true" symbol="5" value="5" label="Confluência"/>
      <category render="true" symbol="6" value="6" label="Ramificação"/>
      <category render="true" symbol="7" value="7" label="Mudança de Atributo"/>
      <category render="true" symbol="8" value="8" label="Nó Próximo a Corpo d'Água"/>
    </categories>
    <symbols>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="41">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="layer"/>
      <column width="-1" hidden="0" type="field" name="node_type"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="node_type" expression=""/>
  </defaults>
