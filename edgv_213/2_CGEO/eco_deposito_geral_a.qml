...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="tipodepgeral" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="Desconhecido"/>
      <category render="true" symbol="1" value="8" label="Galpão"/>
      <category render="true" symbol="2" value="9" label="Silo"/>
      <category render="true" symbol="3" value="99" label="Outros"/>
      <category render="true" symbol="4" value="19" label="Reservatório de Combustível"/>
      <category render="true" symbol="5" value="11" label="Depósito frigorífico"/>
      <category render="true" symbol="6" value="10" label="Composteira"/>
      <category render="true" symbol="7" value="32" label="Armazém"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="195,108,176,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="239,133,109,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE &#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 0 then  'Desconmhecido' &#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 10 then  'Composteira'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 11 then  'Depósito frigorífico'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 19 then  'Reservatório de Combustível'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 32 then  'Armazém'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 8 then  'Galpão'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 9 then  'Silo'&#xd;&#xa;WHEN &quot;tipodepgeral&quot; = 99 then  'Outros'&#xd;&#xa;ELSE&#xd;&#xa;''&#xd;&#xa;END"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="7471201">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="tipodepgeral"/>
      <column width="-1" hidden="0" type="field" name="matconstr"/>
      <column width="-1" hidden="0" type="field" name="tipoexposicao"/>
      <column width="-1" hidden="0" type="field" name="tipoprodutoresiduo"/>
      <column width="-1" hidden="0" type="field" name="tipoconteudo"/>
      <column width="-1" hidden="0" type="field" name="unidadevolume"/>
      <column width="-1" hidden="0" type="field" name="valorvolume"/>
      <column width="-1" hidden="0" type="field" name="tratamento"/>
      <column width="-1" hidden="0" type="field" name="id_org_comerc_serv"/>
      <column width="-1" hidden="0" type="field" name="id_org_ext_mineral"/>
      <column width="-1" hidden="0" type="field" name="id_org_agropec_ext_veg_pesca"/>
      <column width="-1" hidden="0" type="field" name="id_complexo_gerad_energ_eletr"/>
      <column width="-1" hidden="0" type="field" name="id_estrut_transporte"/>
      <column width="-1" hidden="0" type="field" name="id_org_industrial"/>
