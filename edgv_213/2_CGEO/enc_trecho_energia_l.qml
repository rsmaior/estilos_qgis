...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="tensaoeletrica">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="numcircuitos">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="situacaofisica" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="5" label="Construída"/>
      <category render="true" symbol="1" value="3" label="Em Construção"/>
      <category render="true" symbol="2" value="2" label="Destruída"/>
      <category render="true" symbol="3" value="1" label="Abandonada"/>
      <category render="true" symbol="4" value="0" label="Desconhecida"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@2@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="116,142,229,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="circle"/>
              <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="34,182,7,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="138,19,92,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE &#xd;&#xa;WHEN &quot;situacaofisica&quot; = 5 then  'Construída' &#xd;&#xa;WHEN &quot;situacaofisica&quot; = 3 then  'Em Construída'&#xd;&#xa;WHEN &quot;situacaofisica&quot; = 2 then  'Destruída'&#xd;&#xa;WHEN &quot;situacaofisica&quot; = 1 then  'Abandonada'&#xd;&#xa;WHEN &quot;situacaofisica&quot; = 0 then  'Desconhecida'&#xd;&#xa;ELSE&#xd;&#xa;''&#xd;&#xa;END"/>
    ...
    <property key="labeling/multilineHeight" value="2"/>
  ...
  <aliases>
    ...
    <alias field="especie" index="4" name=""/>
    <alias field="posicaorelativa" index="5" name=""/>
    <alias field="operacional" index="6" name=""/>
    <alias field="situacaofisica" index="7" name=""/>
    <alias field="emduto" index="8" name=""/>
    <alias field="tensaoeletrica" index="9" name=""/>
    <alias field="numcircuitos" index="10" name=""/>
    <alias field="id_org_comerc_serv" index="11" name=""/>
    <alias field="lenght_otf" index="12" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="especie"/>
      <column width="-1" hidden="0" type="field" name="posicaorelativa"/>
      <column width="-1" hidden="0" type="field" name="operacional"/>
      <column width="-1" hidden="0" type="field" name="situacaofisica"/>
      <column width="-1" hidden="0" type="field" name="emduto"/>
      <column width="-1" hidden="0" type="field" name="tensaoeletrica"/>
      <column width="-1" hidden="0" type="field" name="numcircuitos"/>
